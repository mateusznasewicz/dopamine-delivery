...
public class StripeService {
    ...
    public String createCheckoutSession(PaymentRequest paymentRequest) throws StripeException {
        ...
        SessionCreateParams.Builder sessionBuilder = SessionCreateParams.builder()
                ...
                .setSuccessUrl("https://dopamine-delivery.mateusznasewicz.dev/dashboard/paymentSuccess")
                .setCancelUrl("https://dopamine-delivery.mateusznasewicz.dev/dashboard/cart")
